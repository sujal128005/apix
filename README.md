...
`960 tests passing · ruff clean · mypy --strict clean · CI on every push`
...
.venv\Scripts\pytest -q                           # expect 960 passed
```
...
**960 tests** — 530 unit, 430 integration. The count is not the point; what it
covers is:
