...
`1063 tests passing · ruff clean · mypy --strict clean · CI on every push`
...
.venv\Scripts\pytest -q                           # expect 1063 passed
```
...
**1,063 tests** — 620 unit, 443 integration. The count is not the point; what it
covers is:
