...
`997 tests passing · ruff clean · mypy --strict clean · CI on every push`
...
.venv\Scripts\pytest -q                           # expect 997 passed
```
...
**997 tests** — 565 unit, 432 integration. The count is not the point; what it
covers is:
